...
export default function NewsPage() {
	...
	return (
		<div className="h-screen flex flex-col">
			<h1 className="text-3xl font-bold mb-6 overflow-hidden m-4 my-2">
				Trending
			</h1>
			<div className="flex-1 overflow-hidden">
				<div
					className="bg-[#f3f4f6] h-full transition-transform duration-300 ease-in-out"
			...
			<div className="flex bottom-0 right-0 left-0 justify-between items-center mb-12 p-2 bg-[#f3f4f6] border-t border-gray-700">
				<Button
					variant="ghost"
					size="sm"
					onClick={() =>
