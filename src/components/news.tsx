...
export default function NewsPage() {
	...
	return (
		<div className="h-screen flex flex-col">
			<h1 className="text-3xl font-bold overflow-hidden m-4 my-2">Trending</h1>
			<div className="flex-1 overflow-hidden">
				<div className="bg-[#f3f4f6] h-full transition-transform duration-300 ease-in-out"
					...
					{newsItems.map((item, index) => (
						<Card
							key={item.id}
							className="h-full border-none rounded-none shadow-none bg-[#f3f4f6]">
							<CardContent className="p-0 h-full flex flex-col">
								...
								<div className="px-4 bottom-0 flex justify-between items-center">
			...
			<div className="bottom-0 fixed right-0 left-0 flex justify-between items-center mb-12 p-2 bg-[#f3f4f6] border-t border-gray-700">
				<Button
					variant="ghost"
					size="sm"
					onClick={() =>
