            ...
            >
              <CardContent className="p-0 h-full flex flex-col">
                <div className="relative h-[248px]">
                  {item.image ? (
                    <Image
                      src={item.image || "/default-image.png"} // Path to your default image
                      alt={item.title}
                      layout="fill"
                      objectFit="cover"
                    />
