...
const products = [
  { id: 1, name: "Fresh Tomatoes", price: 2.99, image: "/placeholder.svg", location: "Green Farm", uploadTime: new Date(2023, 5, 10, 14, 30) },
  { id: 2, name: "Organic Apples", price: 3.99, image: "/placeholder.svg", location: "Orchard Valley", uploadTime: new Date(2023, 5, 11, 9, 15) },
